...
// LITERALINCLUDE START: GUARD IMPL DECLARATION
struct OpenRegGuardImpl final : public impl::DeviceGuardImplInterface {
  ...
  // LITERALINCLUDE END: GUARD IMPL DECLARATION
